  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[collapsible=icon]:peer-data-[state=collapsed]:peer-data-[variant!=inset]:ml-[--sidebar-width-icon]",
        "md:peer-data-[collapsible=icon]:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-[calc(var(--sidebar-width-icon)+theme(spacing.4))]",
        className
      )}
      {...props}
    />
